...
*  Requirement: 6 - The application should include and render an ‘about’ page.
*
*  Status: Completed.
*******************************************************************************/
...
/**
 *  This GET method gathers the 'about' resource and renders it.
 *
...
router.get('/', function(req, res, next) {
  // Render the 'about' page and passes user data.
  res.render('about', {
    user: req.user
  });
});
